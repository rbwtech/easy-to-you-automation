...
pythonfrom easytoyou import IonicubeDecoder

decoder = IonicubeDecoder(username, password, decoder_version)
Constructor Parameters
ParameterTypeDefaultDescriptionusernamestrRequiredeasytoyou.eu usernamepasswordstrRequiredeasytoyou.eu passworddecoderstr"ic11php72"Decoder version to use
Methods
login() -> bool
Authenticate with easytoyou.eu service.
pythonsuccess = decoder.login()
if success:
...
pythonsuccess = decoder.decode_directory(
...
pythonsuccess = decoder.download_decoded_files("./output")
Properties
processed_count: int
...
pythonfrom easytoyou.exceptions import EasyToYouError
...
pythonfrom easytoyou.exceptions import LoginError
...
Utility Functions
File Detection
pythonfrom easytoyou.utils import is_ioncube_file, find_ioncube_files
...
File Operations
pythonfrom easytoyou.utils import create_directory, batch_list
...
File Information
pythonfrom easytoyou.utils import get_file_info, format_file_size
...
pythonfrom easytoyou.session import SessionManager
...
if success: # Use session for custom requests
...
bash# Optional: Set default credentials
